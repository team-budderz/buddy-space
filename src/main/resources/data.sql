...
-- 2. User 데이터 (neighborhood_id = 1 또는 NULL)
...
-- 3. Group 데이터 (leader_id = User의 ID, neighborhood_id = Neighborhood의 ID)
INSERT INTO groups (
    name, description, type, interest,
    is_neighborhood_auth_required, is_mission_group, is_neighborhood_group,
    leader_id, neighborhood_id
) VALUES
      ('Hiking Club', 'Group for weekend hikes', 'ONLINE', 'STUDY', true, false, true, 1, 1),
      ('Book Lovers', 'Discussing books monthly', 'OFFLINE', 'EXERCISE', false, true, false, 2, NULL);
