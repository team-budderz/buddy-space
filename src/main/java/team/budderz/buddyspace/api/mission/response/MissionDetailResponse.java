...
public record MissionDetailResponse(
        ...
        @Schema(description = "미션 생성자 프로필 이미지 url", example = "https://profile.image") String authorImageUrl,
        @Schema(description = "미션 생성 날짜", example = "2025-05-26") LocalDate createdAt
) {
